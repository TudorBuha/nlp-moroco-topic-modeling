...
def load_moroco(raw_dir: Path | str = DEFAULT_RAW_DIR) -> pd.DataFrame:
    ...
    TODO (Phase 1.3): implement. The exact reader depends on the MOROCO
    release format that gets downloaded — adjust accordingly. Make sure
    UTF-8 diacritics survive intact (ș, ț, ă, â, î).
    """
    ...
    raise NotImplementedError("MOROCO loader not yet implemented (Phase 1.3).")
